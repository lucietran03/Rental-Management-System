...
public class UpdateResidentialPropertyRequest extends UpdatePropertyRequest {
    private int numberOfBedrooms;
    private boolean hasGarden;
    private boolean isPetFriendly;

    public UpdateResidentialPropertyRequest(double price, String address, PropertyStatus status, int ownerId,

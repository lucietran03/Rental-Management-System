...
public class UpdateCommercialPropertyRequest extends UpdatePropertyRequest {
    private PropertyBusinessType businessType;
    private double area;
    private boolean hasParking;

    public UpdateCommercialPropertyRequest(double price, String address, PropertyStatus status, int ownerId,

...
public class HostEditResidentialPropertyView implements Initializable {
    @FXML
    ...
    public void initData(ResidentialProperty residentialProperty) {
        ...
        // Set initial values for the property fields
        ...
        // Set garden selection based on property details
        ...
        // Set pet-friendly selection based on property details
        ...
        // Set the current property owner from the list of options
        ...
        // Set the current hosts for the property
        ...
        // Display the property's image if available
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // Load hosts and set the available options for the hosts input
    ...
    public void chooseImage(ActionEvent event) {
        ...
        // If an image is selected, display it and show the remove button
        if (file != null) {
    ...
    public void removeImage(ActionEvent event) {
        // Clear selected image and hide image display
    ...
    public void updateResidentialProperty(ActionEvent event) {
        try {
            ...
            // Parse input values for property update
            ...
            // Create request object for updating property
            ...
            if (selectedImageFile != null) {
                ...
                // Upload new image and store image data in the database
            ...
            // Handle input format errors (non-numeric input for price and bedrooms)
            CustomAlert.show(Alert.AlertType.ERROR, "Input Error",
                    "Please enter valid numeric values for price and number of bedrooms");
        } catch (Exception e) {
            // Handle general errors (e.g., failure to update property)
    ...
    public void returnHome() {
        try {
            // Load Home view (HostAllPropertyView) and display all properties
